...
INSERT TO estudiantes (nombre,nota) 
VALUES('JESuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuUS',10); --esto da un error por que el nombre es muy largo
...
WHERE nombre = 'jose' AND nota = 11;-- cambia el valor de una columna 
 ...
 DROP DATABASE Nombre de la base de datos; --borramos db
